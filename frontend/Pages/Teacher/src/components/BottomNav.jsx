...
const navItems = [
    ...
    { label: 'Time-Table', icon: BookOpen, to: '/teacher/timetable' },            // Home.jsx
    { label: 'Students', icon: User, to: '/teacher/students' },          // Students.jsx
    { label: 'Marks', icon: MessageCircle, to: '/teacher/marks' },       // Marks.jsx
    { label: 'Attendance', icon: BookOpen, to: '/teacher/attendance' },  // Attendance.jsx
    { label: 'Payroll', icon: Wallet, to: '/teacher/payroll' },          // Payroll.jsx
    { label: 'Profile', icon: User, to: '/teacher/profile' },            // Profile.jsx
];
