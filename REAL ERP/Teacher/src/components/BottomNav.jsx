...
const navItems = [
    ...
    { label: 'Time-Table', icon: BookOpen, to: '/timetable' },            // Home.jsx
    { label: 'Students', icon: User, to: '/students' },          // Students.jsx
    { label: 'Marks', icon: MessageCircle, to: '/marks' },       // Marks.jsx
    { label: 'Attendance', icon: BookOpen, to: '/attendance' },  // Attendance.jsx
    { label: 'Payroll', icon: Wallet, to: '/payroll' },          // Payroll.jsx
    // { label: 'Feedbacks', icon: Bell, to: '/feedbacks' },        // Feedback.jsx
      // TimeTable.jsx
    { label: 'Profile', icon: User, to: '/profile' },            // Profile.jsx
];
